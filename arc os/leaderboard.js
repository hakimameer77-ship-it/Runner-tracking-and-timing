...
const larianRef = ref(database, 'larian/');
onValue(larianRef, (snapshot) => {
    ...
    if (data) {
        ...
        runnersArray.forEach((runner, index) => {
            let row = `<tr>
                ...
                <td>${runner.masa_imbasan}</td>
            </tr>`;
            leaderboardTable.innerHTML += row;
        });
    } else {
        leaderboardTable.innerHTML = `<tr><td colspan="3" style="text-align: center; color: #999;">Tiada rekod data dijumpai.</td></tr>`;
    }
});
